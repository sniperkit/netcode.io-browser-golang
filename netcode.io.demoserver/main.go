...
func init() {
  flag.StringVar(&webServerAddr, "webaddr", ":8080", "the web server token supplier address to bind to")
...
func basicHandler(w http.ResponseWriter, r *http.Request) {
  http.ServeFile(w, r, "assets/basic.html")
}
...
func serveToken(w http.ResponseWriter, r *http.Request) {
  ...
  fmt.Fprintf(w, base64.StdEncoding.EncodeToString(tokenData))
}
